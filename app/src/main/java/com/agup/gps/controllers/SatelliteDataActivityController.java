...
public class SatelliteDataActivityController {
	...
	public SatelliteDataActivityController(Activity activity){
		...
		_gpsNMEATextView = (TextView) _activity.findViewById(id.gpsNMEAInfo);
		_gpsSatelliteTextView = (TextView) _activity.findViewById(id.gpsSatelliteInfo);
		_preferences = PreferenceManager.getDefaultSharedPreferences(_activity);		
		_imMainActivity = (ImageView) _activity.findViewById(id.backToMainActivity);
		_startButton = (Button)_activity.findViewById(id.StartSatButton);
		_pauseButton = (Button) _activity.findViewById(id.PauseSatButton);
		_emailButton = (Button) _activity.findViewById(id.EmailSatButton);
	...
	private void setUI(){
		...
		_emailButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				shareIntent.putExtra(Intent.EXTRA_SUBJECT, "Android Satellite Data");
				shareIntent.setType("plain/text"); 
				shareIntent.putExtra(Intent.EXTRA_TEXT, _satelliteList +
						"<br><br>" + _gpsNMEAText);
